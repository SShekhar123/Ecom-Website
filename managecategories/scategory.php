...
?>
                                <div  id="t1"  class="table-responsive">
                                                                           ...
                                                                           <form method="post">
                                                                            ...
                                                                            <div class="col-md-7">
                                                                                <select name="pcat"class="form-control select2" onclick="subcategory(this);">
                                                                                    ...
                                                                                    <?php 
                                  $query="select distinct(category) from categorymap";
                                  ...
                                  <?php
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="product-title" class="col-md-3 control-label">SubCategory Name: </label>
                                                                            <div class="col-md-7">
                                                                                <input type="text" class="form-control" id="cat" required=""name="cat" placeholder="Enter Category">
                                                                            </div>
                                                                        </div>
                                                                         <div class="form-group">
                                                                            <label for="" class="col-md-3 control-label"></label>
                                                                            <div class="col-md-7 text-center">
                                                                                <input type="submit" class="btn btn-primary btn-lg " style="" name="subm" value="Add">
			...
			";?>
                                        ...
                                        </form>   <form method="post" action="subcategoryedit.php">
												<td><?php echo'
												<button type="submit" value="'.$id[$i].'" name="er2" class="btn btn-default">Edit</button>
												';?>	</form>
												 <form method="post" action="subcatdelete.php">
													<?php echo'
												<button type="submit" id="bt" class="btn btn-default" value="'.$id[$i].'" name="del2345" >
