                                                            ...
                                                            <div class="modal-footer">                                                                   
                                                              ...
                                                              <div class="col-md-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-7">
                                                                                <input type="text" class="form-control" id="ID" value="<?php  echo $id[$n]; ?>"  name="ca"required="">
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="col-md-7">
                                                                                <input type="text" class="form-control" id="name" value="<?php  echo $procat[$n]; ?>"  name="cat"required="">
                                                                            </div>
                                                                        </div>
                                                                    <div class="form-group">
                                                                            <label for="Name" class="col-md-3 control-label">subCategory: </label>
                                                                            <div class="col-md-7">
                                                                                <input type="text" class="form-control" id="name" value="<?php  echo $procat1[$n]; ?>"  name="cat12"required="">
                                                                            </div>
                                                                        </div><div class="form-group">
                                                                            <label for="Name" class="col-md-3 control-label">childCategory: </label>
                                                                            <div class="col-md-7">
                                                                                <input type="text" class="form-control" id="name" value="<?php  echo $procat2[$n]; ?>"  name="cat23"required="">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
